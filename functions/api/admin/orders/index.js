...
export async function onRequestGet({ request, env }) {
  ...
  let sql = `SELECT id,protocol,status,person,product_title,price_cents,holder,email,phone,mode,appointment_date,appointment_time,syngulari_protocol,video_url,payment_status,payment_amount_cents,created_at,updated_at FROM orders WHERE 1=1`; const values = [];
